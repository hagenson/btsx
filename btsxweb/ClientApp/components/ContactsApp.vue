...
<script setup lang="ts">
    ...
    async function authenticateNextCloud(type: 'source' | 'dest') {
        ...
        try {
            const request = {
                ...
                implementor: type === 'source' ? sourceServerType.value : destServerType.value,
            };
    ...
    function startMigration() {
        const request: types.ContactTransferRequest = {
            destServer: destServer.value,
            destServiceType: destServerType.value,
            destUseOAuth: !isDestNextCloud.value,
            destUser: destUser.value,
            destOAuthToken: destOAuthToken.value,
            destPassword: destPassword.value,
            sourcePassword: sourcePassword.value,
            sourceServer: sourceServer.value,
            sourceServiceType: sourceServerType.value,
            sourceUseOAuth: !isSourceNextCloud.value,
